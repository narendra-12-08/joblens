        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}
          ...
          {!sent ? (
            <>
              ...
              <p className="text-sm mb-7" style={{ color: 'var(--text-muted)' }}>Enter your email to receive a reset link</p>
              ...
              <form onSubmit={handleReset} className="space-y-4">
                ...
                <motion.button type="submit" disabled={loading}
                  ...
                  className="w-full py-3 rounded-xl text-sm font-bold btn-aurora flex items-center justify-center gap-2">
            ...
            <div className="text-center py-4 space-y-3">
              <CheckCircle className="h-12 w-12 mx-auto" style={{ color: '#34D399' }} />
          ...
          <div className="flex justify-center mt-5">
            <Link href="/login" className="flex items-center gap-1.5 text-sm font-medium hover:underline"
              style={{ color: '#818CF8' }}>
